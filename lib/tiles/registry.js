...
// Row one is the morning, row two is training and the game layer on top of it.
window.TILES = [
  ...
  { id: 'lifting',  name: 'Lifting',  file: 'tiles/lifting.html',  size: 'm', page: true },
  { id: 'progress', name: 'Progress', file: 'tiles/progress.html', size: 'm', page: true },
  { id: 'projects', name: 'Projects', file: 'tiles/projects.html', size: 's', page: true },
]
